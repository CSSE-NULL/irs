/********************************************************************************
** Form generated from reading UI file 'Message_Error.ui'
**
...
#ifndef UI_MESSAGE_ERROR_H
#define UI_MESSAGE_ERROR_H
...
public:
    ...
    void setupUi(QDialog *Message_Error)
    {
        if (Message_Error->objectName().isEmpty())
            Message_Error->setObjectName(QStringLiteral("Message_Error"));
        Message_Error->resize(300, 177);
        QFont font;
        font.setPointSize(9);
        Message_Error->setFont(font);
        Message_Error->setStyleSheet(QStringLiteral(""));
        verticalLayout = new QVBoxLayout(Message_Error);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(1, 1, 1, 1);
        widgetTitle = new QWidget(Message_Error);
...
"}"));
        ...
        widgetInfo = new QWidget(Message_Error);
        ...
        button_box = new QWidget(Message_Error);
        ...
        retranslateUi(Message_Error);

        QMetaObject::connectSlotsByName(Message_Error);
    } // setupUi

    void retranslateUi(QDialog *Message_Error)
    {
        Message_Error->setWindowTitle(QApplication::translate("Message_Error", "Dialog", 0));
        labTitle->setText(QApplication::translate("Message_Error", "\351\224\231\350\257\257", 0));
#ifndef QT_NO_TOOLTIP
        btnMenu_Close->setToolTip(QApplication::translate("Message_Error", "\345\205\263\351\227\255", 0));
#endif // QT_NO_TOOLTIP
        btnMenu_Close->setText(QString());
        label_ico->setText(QString());
        label_info->setText(QString());
        pushButton_confirm->setText(QApplication::translate("Message_Error", "\347\241\256\350\256\244", 0));
    } // retranslateUi

};

namespace Ui {
    class Message_Error: public Ui_Message_Error {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MESSAGE_ERROR_H
