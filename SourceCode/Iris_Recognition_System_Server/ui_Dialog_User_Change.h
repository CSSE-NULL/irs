/********************************************************************************
** Form generated from reading UI file 'Dialog_User_Change.ui'
**
...
#ifndef UI_DIALOG_USER_CHANGE_H
#define UI_DIALOG_USER_CHANGE_H
...
public:
    ...
    void setupUi(QDialog *Dialog_User_Change)
    {
        if (Dialog_User_Change->objectName().isEmpty())
            Dialog_User_Change->setObjectName(QStringLiteral("Dialog_User_Change"));
        Dialog_User_Change->resize(500, 300);
        Dialog_User_Change->setStyleSheet(QStringLiteral(""));
        Dialog_User_Change->setSizeGripEnabled(true);
        verticalLayout = new QVBoxLayout(Dialog_User_Change);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(1, 1, 1, 1);
        widgetTitle = new QWidget(Dialog_User_Change);
        ...
        widgetMain = new QWidget(Dialog_User_Change);
        ...
        retranslateUi(Dialog_User_Change);

        QMetaObject::connectSlotsByName(Dialog_User_Change);
    } // setupUi

    void retranslateUi(QDialog *Dialog_User_Change)
    {
        Dialog_User_Change->setWindowTitle(QApplication::translate("Dialog_User_Change", "Dialog", 0));
        labIco->setText(QString());
        labTitle->setText(QApplication::translate("Dialog_User_Change", "\344\277\256\346\224\271\347\224\250\346\210\267\344\277\241\346\201\257", 0));
#ifndef QT_NO_TOOLTIP
        btnMenu_Min->setToolTip(QApplication::translate("Dialog_User_Change", "\346\234\200\345\260\217\345\214\226", 0));
#endif // QT_NO_TOOLTIP
        btnMenu_Min->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnMenu_Max->setToolTip(QApplication::translate("Dialog_User_Change", "\346\234\200\345\244\247\345\214\226", 0));
#endif // QT_NO_TOOLTIP
        btnMenu_Max->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnMenu_Close->setToolTip(QApplication::translate("Dialog_User_Change", "\345\205\263\351\227\255", 0));
#endif // QT_NO_TOOLTIP
        btnMenu_Close->setText(QString());
        label_user_authority->setText(QApplication::translate("Dialog_User_Change", "\350\257\267\351\200\211\346\213\251\346\226\260\347\232\204\347\224\250\346\210\267\346\235\203\351\231\220\357\274\232", 0));
        label_user_name->setText(QApplication::translate("Dialog_User_Change", "\350\257\267\350\276\223\345\205\245\346\226\260\347\232\204\347\224\250\346\210\267\345\247\223\345\220\215\357\274\232", 0));
        lineEdit_iris->setPlaceholderText(QApplication::translate("Dialog_User_Change", "\350\257\267\351\200\211\346\213\251\350\231\271\350\206\234\345\233\276\347\211\207 | \344\270\215\344\270\272\347\251\272", 0));
        lineEdit_user_name->setPlaceholderText(QApplication::translate("Dialog_User_Change", "\344\270\215\345\244\232\344\272\21610\344\270\252\345\255\227\347\254\246 | \344\270\215\344\270\272\347\251\272", 0));
        pushButton_choose->setText(QApplication::translate("Dialog_User_Change", "...", 0));
        label_iris->setText(QApplication::translate("Dialog_User_Change", "\350\257\267\351\207\215\346\226\260\345\257\271\347\224\250\346\210\267\350\231\271\350\206\234\350\277\233\350\241\214\346\211\253\346\217\217\357\274\232", 0));
        comboBox_user_authority->clear();
        comboBox_user_authority->insertItems(0, QStringList()
         << QApplication::translate("Dialog_User_Change", "Level_1", 0)
         << QApplication::translate("Dialog_User_Change", "Level_2", 0)
         << QApplication::translate("Dialog_User_Change", "Level_3", 0)
        );
        pushButton_confirm->setText(QApplication::translate("Dialog_User_Change", "\347\241\256\350\256\244", 0));
        pushButton_cancel->setText(QApplication::translate("Dialog_User_Change", "\345\217\226\346\266\210", 0));
    } // retranslateUi

};

namespace Ui {
    class Dialog_User_Change: public Ui_Dialog_User_Change {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DIALOG_USER_CHANGE_H
