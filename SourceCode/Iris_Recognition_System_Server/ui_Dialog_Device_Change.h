/********************************************************************************
** Form generated from reading UI file 'Dialog_Device_Change.ui'
**
...
#ifndef UI_DIALOG_DEVICE_CHANGE_H
#define UI_DIALOG_DEVICE_CHANGE_H
...
public:
    ...
    QHBoxLayout *button_box_2;
    QSpacerItem *horizontalSpacer_4;
    QPushButton *pushButton_confirm_2;
    QPushButton *pushButton_cancel_2;
    QSpacerItem *horizontalSpacer_5;

    void setupUi(QDialog *Dialog_Device_Change)
    {
        if (Dialog_Device_Change->objectName().isEmpty())
            Dialog_Device_Change->setObjectName(QStringLiteral("Dialog_Device_Change"));
        Dialog_Device_Change->resize(500, 300);
        Dialog_Device_Change->setStyleSheet(QStringLiteral(""));
        verticalLayout = new QVBoxLayout(Dialog_Device_Change);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(1, 1, 1, 1);
        widgetTitle = new QWidget(Dialog_Device_Change);
        ...
        widgetMain = new QWidget(Dialog_Device_Change);
        ...
        label_device_name = new QLabel(widgetMain);
        label_device_name->setObjectName(QStringLiteral("label_device_name"));

        gridLayout->addWidget(label_device_name, 0, 0, 1, 1);
        ...
        button_box_2 = new QHBoxLayout(widgetButton);
        button_box_2->setSpacing(20);
        button_box_2->setObjectName(QStringLiteral("button_box_2"));
        button_box_2->setContentsMargins(0, 0, 0, 0);
        horizontalSpacer_4 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        button_box_2->addItem(horizontalSpacer_4);

        pushButton_confirm_2 = new QPushButton(widgetButton);
        pushButton_confirm_2->setObjectName(QStringLiteral("pushButton_confirm_2"));

        button_box_2->addWidget(pushButton_confirm_2);

        pushButton_cancel_2 = new QPushButton(widgetButton);
        pushButton_cancel_2->setObjectName(QStringLiteral("pushButton_cancel_2"));

        button_box_2->addWidget(pushButton_cancel_2);

        horizontalSpacer_5 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        button_box_2->addItem(horizontalSpacer_5);

        button_box_2->setStretch(0, 15);
        button_box_2->setStretch(1, 5);
        button_box_2->setStretch(2, 5);
        button_box_2->setStretch(3, 1);
        ...
        retranslateUi(Dialog_Device_Change);

        QMetaObject::connectSlotsByName(Dialog_Device_Change);
    } // setupUi

    void retranslateUi(QDialog *Dialog_Device_Change)
    {
        Dialog_Device_Change->setWindowTitle(QApplication::translate("Dialog_Device_Change", "Dialog", 0));
        labIco->setText(QString());
        labTitle->setText(QApplication::translate("Dialog_Device_Change", "\344\277\256\346\224\271\350\256\276\345\244\207\344\277\241\346\201\257", 0));
#ifndef QT_NO_TOOLTIP
        btnMenu_Min->setToolTip(QApplication::translate("Dialog_Device_Change", "\346\234\200\345\260\217\345\214\226", 0));
#endif // QT_NO_TOOLTIP
        btnMenu_Min->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnMenu_Max->setToolTip(QApplication::translate("Dialog_Device_Change", "\346\234\200\345\244\247\345\214\226", 0));
#endif // QT_NO_TOOLTIP
        btnMenu_Max->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnMenu_Close->setToolTip(QApplication::translate("Dialog_Device_Change", "\345\205\263\351\227\255", 0));
#endif // QT_NO_TOOLTIP
        btnMenu_Close->setText(QString());
        label_position->setText(QApplication::translate("Dialog_Device_Change", "\350\257\267\351\200\211\346\213\251\346\226\260\347\232\204\350\256\276\345\244\207\346\235\203\351\231\220\357\274\232", 0));
        label_device_authority->setText(QApplication::translate("Dialog_Device_Change", "\350\257\267\350\276\223\345\205\245\346\226\260\347\232\204\350\256\276\345\244\207\344\275\215\347\275\256\344\277\241\346\201\257\357\274\232", 0));
        lineEdit_position->setPlaceholderText(QApplication::translate("Dialog_Device_Change", "\344\270\215\345\244\232\344\272\21620\344\270\252\345\255\227\347\254\246 | \344\270\215\344\270\272\347\251\272", 0));
        label_device_name->setText(QApplication::translate("Dialog_Device_Change", "\350\257\267\350\276\223\345\205\245\346\226\260\347\232\204\350\256\276\345\244\207\345\220\215\347\247\260\357\274\232", 0));
        lineEdit_device_name->setPlaceholderText(QApplication::translate("Dialog_Device_Change", "\344\270\215\345\244\232\344\272\21610\344\270\252\345\255\227\347\254\246 | \344\270\215\344\270\272\347\251\272", 0));
        comboBox_device_authority->clear();
        comboBox_device_authority->insertItems(0, QStringList()
         << QApplication::translate("Dialog_Device_Change", "Level_1", 0)
         << QApplication::translate("Dialog_Device_Change", "Level_2", 0)
         << QApplication::translate("Dialog_Device_Change", "Level_3", 0)
        );
        pushButton_confirm_2->setText(QApplication::translate("Dialog_Device_Change", "\347\241\256\350\256\244", 0));
        pushButton_cancel_2->setText(QApplication::translate("Dialog_Device_Change", "\345\217\226\346\266\210", 0));
    } // retranslateUi

};

namespace Ui {
    class Dialog_Device_Change: public Ui_Dialog_Device_Change {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DIALOG_DEVICE_CHANGE_H
